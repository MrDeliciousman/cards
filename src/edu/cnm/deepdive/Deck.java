...
public class Deck {
   ...
   * #shuffle(Random)} method must
   * be invoked after intitialization, prior to deal any cards.
  ...
  /**
   * Returns all cards to the pile, and shuffles it, readying it for viewing.
   *
